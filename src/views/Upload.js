...
import {Button, Grid, CircularProgress, Slider, Typography} from '@material-ui/core';
            ...
            <Grid container item>
                ...
                <Grid container item>
                    <TextValidator
                        ...
                        //value={inputs.file}
                        /* validators={['maxFileSize:' + 1 * 1024 * 1024,'allowedExtensions:image/*,video/*,audio/*']}
                        errorMessages={['image/video/audio files only']} */
                    />
                </Grid>
                <Grid container item>
                    <Button 
